...
const features: featureProps[] = [
  ...
  },
  {
    ...
    description: "Engage with interactive content, quizzes, and assignments to enhance you learning experience.",
    icon: "🎮",
  },
  {
    title: "Progress Tracking",
    description: "Monitor your progress and achievements with detailed analytics and personalised dashboards.",
    icon: "📊",
  },
  {
    ...
    <>
      <section className="relative py-20">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Improve your learning experience</h1>
